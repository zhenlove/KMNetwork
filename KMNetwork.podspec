#
# Be sure to run `pod lib lint KMNetwork.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhenlove/KMNetwork'
  ...
  s.swift_version = '5.0'
#  s.xcconfig     = { 'VALID_ARCHS' => 'armv7 arm64 x86_64', } #可以不用着一行
  s.source_files = 'KMNetwork/Classes/**/*'
  
  # s.resource_bundles = {
  #   'KMNetwork' => ['KMNetwork/Assets/*.png']
  # }
